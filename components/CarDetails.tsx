                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className=" relative w-full max-w-lg max-h-[90vh] p-6 transform overflow-y-auto rounded-2xl bg-white text-left align-middle shadow-xl transition-all flex flex-col gap-5">
                                    <button
                                        type="button"
                                        onClick={closeModal}
                                            ...
                                            {Object.entries(car).map(
                                                ([key, value]) => (
                                                    <div
                                                        ...
                                                        key={key}
                                                    >
                                                        <h4 className="text-[#666666] capitalize">
                                                            {key
                                                                .split("_")
                                                                .join(" ")}
                                                        </h4>
